...
namespace iS3.Core
{
    ...
    {
        // Summary:
        //     Added objects are stored in a dictionary whose key is the DGObjects Definition Name
        ...
        public string getAddedObjsLayer3DName(string objDef)
        {
            if ((addedObjs != null) && (addedObjs.Values.Count > 0))
            {
                DGObject obj = addedObjs[objDef].FirstOrDefault();
        ...
        public string getRemovedObjsGISLayerName(string objDef)
        {
    ...
    //Summary:
    //     DGObjects selection changed event args
    public class DGObjectsSelectionChangedEventArgs : EventArgs
    {
        public DGObjects addedObjs;
        public DGObjects removedObjs;
    }
